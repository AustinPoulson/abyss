...
export const COLOR_PRESETS = Object.freeze([
  ...
  ["Rainbow Mainstage", ["#ff0000", "#ff7f00", "#ffff00", "#00ff00", "#00ffff", "#0000ff", "#8b00ff", "#ff00ff"]],
...
export const BACKGROUND_EFFECT_CONTROL_SPECS = Object.freeze({
  ...
  sparkle: [["minSize", "Minimum size", 24, 240, "px"], ["maxSize", "Maximum size", 80, 1200, "px"], ["quantity", "Stars per beat", 1, 8, ""], ["diffusion", "Diffusion", 0, 100, "%"], ["intensity", "Intensity", 10, 100, "%"], ["rayWidth", "Ray width", 8, 45, "%"], ["fadeIn", "Fade in", 0, 100, "%"]],
  slime: [["speed", "Pour speed", 40, 200, "%"], ["dripDepth", "Drip depth", 40, 240, "px"], ["complexity", "Shape complexity", 3, 12, ""]]
});
...
export const DEFAULTS = Object.freeze({
  ...
  background: {
    ...
    effectSettings: {
      strobe: { randomness: 0 },
      fade: { duration: 100 },
      sparkle: { minSize: 48, maxSize: 600, quantity: 1, diffusion: 60, intensity: 78, rayWidth: 20, fadeIn: 35 },
      slime: { speed: 100, dripDepth: 130, complexity: 7 }
    }
  },
  fractal: { enabled: true, style: "ink", symmetry: 8, recursion: 3, rotation: 18, pulse: 38, distortion: 55, centerX: 50, centerY: 50, opacity: 72, blend: "screen", trail: 18, crossfade: 35, division: "1/4", colorMode: "palette" },
  tempo: 120,
  palette: "ice",
  density: 42,
  motion: 34,
...
export function normalizeSettings(loaded) {
  ...
  next.background.effectSettings = Object.assign({}, cloneSettings(DEFAULTS.background.effectSettings), next.background.effectSettings);
  Object.keys(DEFAULTS.background.effectSettings).forEach((effect) => {
    next.background.effectSettings[effect] = Object.assign({}, DEFAULTS.background.effectSettings[effect], next.background.effectSettings[effect]);
  });
